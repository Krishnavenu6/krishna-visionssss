        ...
        <div className={`text-center transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative mb-8">
            <div className="w-48 h-48 mx-auto relative">
              ...
              {/* Core image */}
              <div className="absolute inset-8 rounded-full overflow-hidden border-2 border-primary shadow-intense">
                <img 
                  src={krishnaProfile} 
                  alt="Krishna Venu Subrahmanyam" 
          ...
          {/* Main Title */}
          <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-nexus bg-clip-text text-transparent animate-cyber-slide">
            Digital Nexus
          </h1>
